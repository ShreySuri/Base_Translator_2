...
while base % 1 != 0 or base < 2 or base > 36:
    base = input(print("Please enter the base of the integer. "))
    print("")
    base = float(base)
base = int(base)

num_original = input(print("What integer would you like to convert to base 10? If you are unsure how to enter this string, please type 'map'. "))
